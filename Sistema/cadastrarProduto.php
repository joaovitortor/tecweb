...
if (isset($_POST['salvar'])) {
    ...
    //3. Preparar a SQL
    $sql = "insert into produto (nome, unidadeDeMedida) values ('$nome', '$unidadeDeMedida')";
...
<form method="post" class="container">
    ...
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" value="<?= $unidadeDeMedida ?>" name="unidadeDeMedida" placeholder="Unidade de Medida">
        </div>
